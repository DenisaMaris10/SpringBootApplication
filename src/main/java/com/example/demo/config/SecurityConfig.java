    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                .authorizeHttpRequests(authConfig -> {
                    ...
                    authConfig.requestMatchers(HttpMethod.GET, "/events/create").hasAuthority("ADMIN");
                    authConfig.requestMatchers(HttpMethod.GET, "/events/delete").hasAuthority("ADMIN");
                    authConfig.requestMatchers(HttpMethod.GET, "/categories/delete").hasAuthority("ADMIN");
                    authConfig.requestMatchers(HttpMethod.GET, "/categories/create").hasAuthority("ADMIN");
